...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right"> Serial no </label>
                <div class="col-sm-2">
                    <input type="text" id="invoiceNo" class="form-control" v-model="sales.serial_no" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right"> Truck No </label>
                <div class="col-sm-2">
                    <v-select v-bind:options="trucks" v-model="selectedTruck" label="Truck_Name" placeholder="Select Truck"></v-select>
                </div>
            </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            async saveSales() {
                ...
                if (this.selectedTruck != null && this.selectedTruck.Truck_SlNo != null) {
                    this.sales.truck_id = this.selectedTruck.Truck_SlNo;
                } else {
                    this.sales.truck_id = null;
                }
